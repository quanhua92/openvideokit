	...
	},
	{
		...
		build: ({ slideId }) => ({
			...
			proposal: {
				...
				tier: 2,
				target: { kind: "slide", slideId },
				html: `<template><div data-composition-id="__SLIDE_ID__"><h1 class="text-9xl">__TITLE__</h1><p>__BODY__</p></div></template>`,
				rationale: "Bumped h1 to 9xl, removed extra padding.",
			},
		}),
	},
	{
