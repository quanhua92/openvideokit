	...
	},
	{
		...
		build: ({ slideId }) => ({
			...
			proposal: {
				...
				tier: 2,
				target: { kind: "slide", slideId },
				html: `<template><div data-composition-id="__OVK_SLIDE_ID__" data-width="1920" data-height="1080"><div class="content"><h1>__OVK_TITLE__</h1><p>__OVK_BODY__</p></div><style>[data-composition-id="__OVK_SLIDE_ID__"] { background: #0a0a14; color: white; } [data-composition-id="__OVK_SLIDE_ID__"] .content { text-align: center; padding-top: 30vh; } [data-composition-id="__OVK_SLIDE_ID__"] h1 { font-size: 300px; font-weight: 800; margin-bottom: 24px; letter-spacing: -0.04em; } [data-composition-id="__OVK_SLIDE_ID__"] p { font-size: 60px; font-weight: 400; opacity: 0.9; }</style></div></template>`,
	...
	},
	{
		...
		build: ({ slideId }) => ({
			...
			proposal: {
				...
				html: `<template><div data-composition-id="__OVK_SLIDE_ID__" data-width="1920" data-height="1080"><div class="content"><h1>Pricing Plans</h1><p>__OVK_BODY__</p></div><style>[data-composition-id="__OVK_SLIDE_ID__"] { background: #1a1a2e; color: white; } [data-composition-id="__OVK_SLIDE_ID__"] .content { text-align: center; padding-top: 30vh; } [data-composition-id="__OVK_SLIDE_ID__"] h1 { font-size: 140px; font-weight: 800; color: #4ade80; } [data-composition-id="__OVK_SLIDE_ID__"] p { font-size: 70px; font-weight: 600; }</style></div></template>`,
				rationale:
