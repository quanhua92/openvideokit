  ...
  },
  {
    ...
    build: (ctx) =>
      withStream("Try this — same fields, bigger type, tighter spacing.", {
        ...
        html: `<template>\n  <div data-composition-id="__OVK_SLIDE_ID__" data-width="1920" data-height="1080">\n    <div class="content">\n      <h1>__OVK_TITLE__</h1>\n      <p>__OVK_BODY__</p>\n    </div>\n    <style>\n      [data-composition-id="__OVK_SLIDE_ID__"] { background: #0a0a14; color: white; }\n      [data-composition-id="__OVK_SLIDE_ID__"] .content { text-align: center; padding-top: 30vh; }\n      [data-composition-id="__OVK_SLIDE_ID__"] h1 { font-size: 300px; font-weight: 800; margin-bottom: 24px; letter-spacing: -0.04em; }\n      [data-composition-id="__OVK_SLIDE_ID__"] p { font-size: 60px; font-weight: 400; opacity: 0.9; }\n    </style>\n  </div>\n</template>`,
  ...
  },
  {
    ...
    build: (ctx) =>
      withStream("Here's a new pricing slide layout.", {
        ...
        newId: rand(),
        html: `<template>\n  <div data-composition-id="__OVK_SLIDE_ID__" data-width="1920" data-height="1080">\n    <div class="content">\n      <h1>Pricing Plans</h1>\n      <p>__OVK_BODY__</p>\n    </div>\n    <style>\n      [data-composition-id="__OVK_SLIDE_ID__"] { background: #1a1a2e; color: white; }\n      [data-composition-id="__OVK_SLIDE_ID__"] .content { text-align: center; padding-top: 30vh; }\n      [data-composition-id="__OVK_SLIDE_ID__"] h1 { font-size: 140px; font-weight: 800; color: #4ade80; }\n      [data-composition-id="__OVK_SLIDE_ID__"] p { font-size: 70px; font-weight: 600; }\n    </style>\n  </div>\n</template>`,
